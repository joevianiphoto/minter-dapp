...
const layerConfigurations = [
  {
    growEditionSizeTo: 15,    ///Floppy ears randon (3400)
    layersOrder: [
      //{ name: "Background" },
  ...
  {
    growEditionSizeTo: 45,    ///Pointed ears randon (3000) 6800
    layersOrder: [
      //{ name: "Background" },
      { name: "Mat" , displayName : "Floor Mat"},  
  ...
  {
    growEditionSizeTo: 60,    ///Floppy brindle ears randon (100) 6900
    layersOrder: [ 
      //{ name: "Background" },
      { name: "Mat" , displayName : "Floor Mat"},  
  ...
  {
    growEditionSizeTo:  75,    ///Pointed brindle randon (100) 7000
    layersOrder: [
      //{ name: "Background" },
      { name: "Mat" , displayName : "Floor Mat"},  
